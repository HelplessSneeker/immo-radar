...
- **Provenienz ist keine Kachel:** Eine Kachel bekommt nur, was ein Urteil trägt (Rendite, Kauf, Miete). Datenherkunft — letzter Sweep, Roh-Inserate-Zählung, „Sweep läuft" — steht als Meta-Zeile unter dem Kachel-Grid (zusammen mit „Alle Kennzahlen erklärt → Methodik"), nicht als vierte Zahl daneben.
...
- Dashboard und Top Picks tragen unter der h1 eine Orientierungszeile in Plain Language (14px, Tinte, `max-width: 64ch`), die in einfachen Worten sagt, wofür die Seite da ist — für Nicht-Techniker (die Zielgruppe der Startseiten). Sie sitzt in der Hierarchie bewusst zwischen h1 (20px, Tinte) und der grauen Herkunfts-Meta (13px, gedämpft) und ersetzt die technische Provenienz-Zeile nicht, sondern führt sie ein. Kein Marketing-Ton, kein Ausrufezeichen — die ruhige Anmutung bleibt.
- **Die h1 bleibt schlank:** nur der Seitenname bzw. Markt („Wohnungsmarkt Kärnten", „Top Picks"). Stichtag und Methodisches gehören in die Meta-Zeile; ein aktiver Filter steht als eigene Meta-Zeile „Gefiltert: PLZ 9020 · 45–90 m²" darunter (nur sichtbar, wenn gefiltert) — nie in der Überschrift.
